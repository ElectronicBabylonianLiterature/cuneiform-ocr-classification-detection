...
train_list = [
    ...
    _base_.cocotextv1_textrecog_train,
    _base_.iiit5k_textrecog_train,
    _base_.mjsynth_sub_textrecog_train,
    _base_.synthtext_sub_textrecog_train,
...
train_list = [
    ...
    dict(type="ConcatDataset", datasets=train_list[5:], pipeline=_base_.train_pipeline),
]
